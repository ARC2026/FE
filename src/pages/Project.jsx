...
export default function Project() {
  ...
  const filters = ["ALL", "BRANDING", "GRAPHIC", "PRODUCT", "SPACE", "UX/UI", "VIDEO", "3D"];
  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerTitle}>BETWEEN FRAGMENTS, A STORY FORMS</div>
        <div className={styles.footerContent}>
          <div className={styles.footerLeft}>
            <div className={styles.footerText}>대학생 연합 전시회 ARC</div>
            <div className={styles.footerText}>서울특별시 종로구 인사동 5길 14</div>
          ...
          <div className={styles.footerRight}>
            ...
            <div className={styles.footerText}>SEOUL JONGNO-GU INSADONG 5-GIL 14,</div>
            <div className={styles.footerText}>MARU ART CENTER B1F SPECIAL EXHIBITION HALL</div>
            <div className={styles.footerText}>© 2026. ARC All rights reserved.</div>
          </div>
